...
class RequiredEmployeeGender(TypedDict):
    pass

class OptionalEmployeeGender(TypedDict, total=False):
...
class EmployeeGender(RequiredEmployeeGender, OptionalEmployeeGender):
    pass
