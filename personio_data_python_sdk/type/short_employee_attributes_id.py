...
class RequiredShortEmployeeAttributesId(TypedDict):
    pass

class OptionalShortEmployeeAttributesId(TypedDict, total=False):
...
class ShortEmployeeAttributesId(RequiredShortEmployeeAttributesId, OptionalShortEmployeeAttributesId):
    pass
