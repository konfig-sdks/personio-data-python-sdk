...
class RequiredEmployeeWeeklyWorkingHours(TypedDict):
    pass

class OptionalEmployeeWeeklyWorkingHours(TypedDict, total=False):
...
class EmployeeWeeklyWorkingHours(RequiredEmployeeWeeklyWorkingHours, OptionalEmployeeWeeklyWorkingHours):
    pass
