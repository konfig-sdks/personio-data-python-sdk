...
class RequiredEmployeeTerminationType(TypedDict):
    pass

class OptionalEmployeeTerminationType(TypedDict, total=False):
...
class EmployeeTerminationType(RequiredEmployeeTerminationType, OptionalEmployeeTerminationType):
    pass
