...
class RequiredEmployeeFixSalary(TypedDict):
    pass

class OptionalEmployeeFixSalary(TypedDict, total=False):
...
class EmployeeFixSalary(RequiredEmployeeFixSalary, OptionalEmployeeFixSalary):
    pass
