...
class RequiredShortEmployeeAttributesFirstName(TypedDict):
    pass

class OptionalShortEmployeeAttributesFirstName(TypedDict, total=False):
...
class ShortEmployeeAttributesFirstName(RequiredShortEmployeeAttributesFirstName, OptionalShortEmployeeAttributesFirstName):
    pass
