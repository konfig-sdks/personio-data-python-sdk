...
class RequiredEmployeePreferredName(TypedDict):
    pass

class OptionalEmployeePreferredName(TypedDict, total=False):
...
class EmployeePreferredName(RequiredEmployeePreferredName, OptionalEmployeePreferredName):
    pass
