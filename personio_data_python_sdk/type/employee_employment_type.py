...
class RequiredEmployeeEmploymentType(TypedDict):
    pass

class OptionalEmployeeEmploymentType(TypedDict, total=False):
...
class EmployeeEmploymentType(RequiredEmployeeEmploymentType, OptionalEmployeeEmploymentType):
    pass
