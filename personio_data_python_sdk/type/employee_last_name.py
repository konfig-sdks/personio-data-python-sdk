...
class RequiredEmployeeLastName(TypedDict):
    pass

class OptionalEmployeeLastName(TypedDict, total=False):
...
class EmployeeLastName(RequiredEmployeeLastName, OptionalEmployeeLastName):
    pass
