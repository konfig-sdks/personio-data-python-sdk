...
class RequiredEmployeePosition(TypedDict):
    pass

class OptionalEmployeePosition(TypedDict, total=False):
...
class EmployeePosition(RequiredEmployeePosition, OptionalEmployeePosition):
    pass
