...
class RequiredEmployeeContractEndDate(TypedDict):
    pass

class OptionalEmployeeContractEndDate(TypedDict, total=False):
...
class EmployeeContractEndDate(RequiredEmployeeContractEndDate, OptionalEmployeeContractEndDate):
    pass
