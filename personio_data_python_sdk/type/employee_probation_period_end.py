...
class RequiredEmployeeProbationPeriodEnd(TypedDict):
    pass

class OptionalEmployeeProbationPeriodEnd(TypedDict, total=False):
...
class EmployeeProbationPeriodEnd(RequiredEmployeeProbationPeriodEnd, OptionalEmployeeProbationPeriodEnd):
    pass
