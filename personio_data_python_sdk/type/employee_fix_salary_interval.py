...
class RequiredEmployeeFixSalaryInterval(TypedDict):
    pass

class OptionalEmployeeFixSalaryInterval(TypedDict, total=False):
...
class EmployeeFixSalaryInterval(RequiredEmployeeFixSalaryInterval, OptionalEmployeeFixSalaryInterval):
    pass
