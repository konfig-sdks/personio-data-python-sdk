...
class RequiredEmployeeFirstName(TypedDict):
    pass

class OptionalEmployeeFirstName(TypedDict, total=False):
...
class EmployeeFirstName(RequiredEmployeeFirstName, OptionalEmployeeFirstName):
    pass
