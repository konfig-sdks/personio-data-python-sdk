...
class RequiredEmployeeTerminationReason(TypedDict):
    pass

class OptionalEmployeeTerminationReason(TypedDict, total=False):
...
class EmployeeTerminationReason(RequiredEmployeeTerminationReason, OptionalEmployeeTerminationReason):
    pass
