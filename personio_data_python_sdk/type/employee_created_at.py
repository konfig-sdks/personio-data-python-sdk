...
class RequiredEmployeeCreatedAt(TypedDict):
    pass

class OptionalEmployeeCreatedAt(TypedDict, total=False):
...
class EmployeeCreatedAt(RequiredEmployeeCreatedAt, OptionalEmployeeCreatedAt):
    pass
