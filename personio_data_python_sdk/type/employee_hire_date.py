...
class RequiredEmployeeHireDate(TypedDict):
    pass

class OptionalEmployeeHireDate(TypedDict, total=False):
...
class EmployeeHireDate(RequiredEmployeeHireDate, OptionalEmployeeHireDate):
    pass
