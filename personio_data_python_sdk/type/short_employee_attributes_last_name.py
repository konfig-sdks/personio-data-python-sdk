...
class RequiredShortEmployeeAttributesLastName(TypedDict):
    pass

class OptionalShortEmployeeAttributesLastName(TypedDict, total=False):
...
class ShortEmployeeAttributesLastName(RequiredShortEmployeeAttributesLastName, OptionalShortEmployeeAttributesLastName):
    pass
