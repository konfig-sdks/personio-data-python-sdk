...
class RequiredEmployeeVacationDayBalance(TypedDict):
    pass

class OptionalEmployeeVacationDayBalance(TypedDict, total=False):
...
class EmployeeVacationDayBalance(RequiredEmployeeVacationDayBalance, OptionalEmployeeVacationDayBalance):
    pass
