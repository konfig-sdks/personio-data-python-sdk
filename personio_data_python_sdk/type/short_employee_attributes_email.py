...
class RequiredShortEmployeeAttributesEmail(TypedDict):
    pass

class OptionalShortEmployeeAttributesEmail(TypedDict, total=False):
...
class ShortEmployeeAttributesEmail(RequiredShortEmployeeAttributesEmail, OptionalShortEmployeeAttributesEmail):
    pass
