...
class RequiredEmployeeLastWorkingDay(TypedDict):
    pass

class OptionalEmployeeLastWorkingDay(TypedDict, total=False):
...
class EmployeeLastWorkingDay(RequiredEmployeeLastWorkingDay, OptionalEmployeeLastWorkingDay):
    pass
