...
class RequiredEmployeeTerminationDate(TypedDict):
    pass

class OptionalEmployeeTerminationDate(TypedDict, total=False):
...
class EmployeeTerminationDate(RequiredEmployeeTerminationDate, OptionalEmployeeTerminationDate):
    pass
