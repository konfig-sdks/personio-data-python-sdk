...
class RequiredEmployeeProfilePicture(TypedDict):
    pass

class OptionalEmployeeProfilePicture(TypedDict, total=False):
...
class EmployeeProfilePicture(RequiredEmployeeProfilePicture, OptionalEmployeeProfilePicture):
    pass
