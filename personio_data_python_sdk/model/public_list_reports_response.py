...
class PublicListReportsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PublicReportData']:
                        return PublicReportData
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PublicReportData'], typing.List['PublicReportData']],
                ...
                def __getitem__(self, i: int) -> 'PublicReportData':
