...
class Attendance404ErrorResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['Attendance404ErrorResponseError']:
                return Attendance404ErrorResponseError
            __annotations__ = {
                "success": success,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'Attendance404ErrorResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['Attendance404ErrorResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['Attendance404ErrorResponseError', schemas.Unset] = schemas.unset,
