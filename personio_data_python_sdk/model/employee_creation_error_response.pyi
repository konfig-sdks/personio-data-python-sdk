...
class EmployeeCreationErrorResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['EmployeeCreationErrorResponseError']:
                return EmployeeCreationErrorResponseError
            __annotations__ = {
                "success": success,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'EmployeeCreationErrorResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['EmployeeCreationErrorResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['EmployeeCreationErrorResponseError', schemas.Unset] = schemas.unset,
