...
class CreateAbsencePeriodRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            start_time = schemas.DateSchema
            end_time = schemas.DateSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employee_id", "time_off_type_id", "start_date", "end_date", "start_time", "end_time", "half_day_start", "half_day_end", "comment", "skip_approval", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employee_id", "time_off_type_id", "start_date", "end_date", "start_time", "end_time", "half_day_start", "half_day_end", "comment", "skip_approval", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        start_time: typing.Union[MetaOapg.properties.start_time, str, date, schemas.Unset] = schemas.unset,
        end_time: typing.Union[MetaOapg.properties.end_time, str, date, schemas.Unset] = schemas.unset,
