...
class EntityAttribute(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attribute_id", "entity_id", "data_type", "value", "employee_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attribute_id", "entity_id", "data_type", "value", "employee_id", ], str]):
