...
class PublicHistoricalReportItemsAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def columns() -> typing.Type['PublicHistoricalReportItemsAttributesColumns']:
                return PublicHistoricalReportItemsAttributesColumns
        
            @staticmethod
            def filters() -> typing.Type['PublicHistoricalReportItemsAttributesFilters']:
                return PublicHistoricalReportItemsAttributesFilters
            ...
            @staticmethod
            def items() -> typing.Type['PublicHistoricalReportItemsAttributesItems']:
                return PublicHistoricalReportItemsAttributesItems
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["columns"]) -> 'PublicHistoricalReportItemsAttributesColumns': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["filters"]) -> 'PublicHistoricalReportItemsAttributesFilters': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["period_type"]) -> MetaOapg.properties.period_type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'PublicHistoricalReportItemsAttributesItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["columns"]) -> typing.Union['PublicHistoricalReportItemsAttributesColumns', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["filters"]) -> typing.Union['PublicHistoricalReportItemsAttributesFilters', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> typing.Union['PublicHistoricalReportItemsAttributesItems', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        columns: typing.Union['PublicHistoricalReportItemsAttributesColumns', schemas.Unset] = schemas.unset,
        filters: typing.Union['PublicHistoricalReportItemsAttributesFilters', schemas.Unset] = schemas.unset,
        period_type: typing.Union[MetaOapg.properties.period_type, str, schemas.Unset] = schemas.unset,
        items: typing.Union['PublicHistoricalReportItemsAttributesItems', schemas.Unset] = schemas.unset,
