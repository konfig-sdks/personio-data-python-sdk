...
class DocumentUploadFailedWithUnsupportedFileTypeResponse(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class error(
                        ...
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["error_data"]) -> MetaOapg.properties.error_data: ...
                        
                        @typing.overload
                        def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                        
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "code", "error_data", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        ...
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["error_data"]) -> typing.Union[MetaOapg.properties.error_data, schemas.Unset]: ...
                        
                        @typing.overload
                        def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                        
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "code", "error_data", ], str]):
                            return super().get_item_oapg(name)
                        ...
                        def __new__(
                            ...
                            *args: typing.Union[dict, frozendict.frozendict, ],
                            ...
                            error_data: typing.Union[MetaOapg.properties.error_data, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
                            _configuration: typing.Optional[schemas.Configuration] = None,
                            **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                        ) -> 'error':
                            return super().__new__(
