...
class AbsencesListTimeOffTypesResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TimeOffTypeResource']:
                        return TimeOffTypeResource
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TimeOffTypeResource'], typing.List['TimeOffTypeResource']],
                ...
                def __getitem__(self, i: int) -> 'TimeOffTypeResource':
