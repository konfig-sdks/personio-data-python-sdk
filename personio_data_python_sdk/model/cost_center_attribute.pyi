...
class CostCenterAttribute(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attribute_id", "data_type", "employee_id", "cost_centers", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attribute_id", "data_type", "employee_id", "cost_centers", ], str]):
