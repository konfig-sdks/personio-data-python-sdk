...
class ErrorCreateAbsenceResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['ErrorCreateAbsenceResponseError']:
                return ErrorCreateAbsenceResponseError
            __annotations__ = {
                "success": success,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'ErrorCreateAbsenceResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['ErrorCreateAbsenceResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['ErrorCreateAbsenceResponseError', schemas.Unset] = schemas.unset,
