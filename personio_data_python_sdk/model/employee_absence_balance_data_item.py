...
class EmployeeAbsenceBalanceDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "category", "balance", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "category", "balance", ], str]):
    ...
    ) -> 'EmployeeAbsenceBalanceDataItem':
