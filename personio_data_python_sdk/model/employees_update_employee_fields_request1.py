...
class EmployeesUpdateEmployeeFieldsRequest1(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employee[first_name]", "employee[last_name]", "employee[preferred_name]", "employee[gender]", "employee[position]", "employee[department]", "employee[hire_date]", "employee[weekly_working_hours]", "employee[supervisor_id]", "employee[status]", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["employee[first_name]"]) -> typing.Union[MetaOapg.properties.employee_first_name, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["employee[last_name]"]) -> typing.Union[MetaOapg.properties.employee_last_name, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employee[first_name]", "employee[last_name]", "employee[preferred_name]", "employee[gender]", "employee[position]", "employee[department]", "employee[hire_date]", "employee[weekly_working_hours]", "employee[supervisor_id]", "employee[status]", ], str]):
