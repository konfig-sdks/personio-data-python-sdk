...
class PublicReportItemsAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def columns() -> typing.Type['PublicReportItemsAttributesColumns']:
                return PublicReportItemsAttributesColumns
        
            @staticmethod
            def filters() -> typing.Type['PublicReportItemsAttributesFilters']:
                return PublicReportItemsAttributesFilters
            ...
            class period_type(
                ...
                @schemas.classproperty
                def LAST_DAY_OF_THIS_WEEK(cls):
                    return cls("last_day_of_this_week")
                
                @schemas.classproperty
                def LAST_DAY_OF_LAST_WEEK(cls):
                    return cls("last_day_of_last_week")
                ...
                @schemas.classproperty
                def LAST_DAY_OF_LAST_MONTH(cls):
                    return cls("last_day_of_last_month")
                
                @schemas.classproperty
                def LAST_DAY_OF_THIS_QUARTER(cls):
                    return cls("last_day_of_this_quarter")
                
                @schemas.classproperty
                def LAST_DAY_OF_LAST_QUARTER(cls):
                    return cls("last_day_of_last_quarter")
                
                @schemas.classproperty
                def LAST_DAY_OF_THIS_YEAR(cls):
                    return cls("last_day_of_this_year")
                
                @schemas.classproperty
                def LAST_DAY_OF_LAST_YEAR(cls):
                    return cls("last_day_of_last_year")
        
            @staticmethod
            def items() -> typing.Type['PublicReportItemsAttributesItems']:
                return PublicReportItemsAttributesItems
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["columns"]) -> 'PublicReportItemsAttributesColumns': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["filters"]) -> 'PublicReportItemsAttributesFilters': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["period_type"]) -> MetaOapg.properties.period_type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'PublicReportItemsAttributesItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["columns"]) -> typing.Union['PublicReportItemsAttributesColumns', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["filters"]) -> typing.Union['PublicReportItemsAttributesFilters', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> typing.Union['PublicReportItemsAttributesItems', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        columns: typing.Union['PublicReportItemsAttributesColumns', schemas.Unset] = schemas.unset,
        filters: typing.Union['PublicReportItemsAttributesFilters', schemas.Unset] = schemas.unset,
        period_type: typing.Union[MetaOapg.properties.period_type, str, schemas.Unset] = schemas.unset,
        items: typing.Union['PublicReportItemsAttributesItems', schemas.Unset] = schemas.unset,
