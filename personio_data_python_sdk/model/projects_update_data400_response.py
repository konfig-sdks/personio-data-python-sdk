...
class ProjectsUpdateData400Response(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def error() -> typing.Type['ProjectsUpdateData400ResponseError']:
                return ProjectsUpdateData400ResponseError
            __annotations__ = {
                "success": success,
                "error": error,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error"]) -> 'ProjectsUpdateData400ResponseError': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error"]) -> typing.Union['ProjectsUpdateData400ResponseError', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        error: typing.Union['ProjectsUpdateData400ResponseError', schemas.Unset] = schemas.unset,
