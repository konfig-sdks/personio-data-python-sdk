...
class AbsencePeriodAttribute(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data_type(
                ...
                def ABSENCE_PERIOD(cls):
                    return cls("ABSENCE_PERIOD")
            start_date = schemas.DateSchema
            end_date = schemas.DateSchema
            half_day_at_start = schemas.BoolSchema
            half_day_at_end = schemas.BoolSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["half_day_at_start"]) -> MetaOapg.properties.half_day_at_start: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["half_day_at_end"]) -> MetaOapg.properties.half_day_at_end: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attribute_id", "data_type", "start_date", "end_date", "half_day_at_start", "half_day_at_end", "employee_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["half_day_at_start"]) -> typing.Union[MetaOapg.properties.half_day_at_start, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["half_day_at_end"]) -> typing.Union[MetaOapg.properties.half_day_at_end, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attribute_id", "data_type", "start_date", "end_date", "half_day_at_start", "half_day_at_end", "employee_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        half_day_at_start: typing.Union[MetaOapg.properties.half_day_at_start, bool, schemas.Unset] = schemas.unset,
        half_day_at_end: typing.Union[MetaOapg.properties.half_day_at_end, bool, schemas.Unset] = schemas.unset,
