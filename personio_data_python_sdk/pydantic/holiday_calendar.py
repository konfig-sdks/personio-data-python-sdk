...
from personio_data_python_sdk.pydantic.holiday_calendar_value import HolidayCalendarValue
...
class HolidayCalendar(BaseModel):
    ...
    value: typing.Optional[HolidayCalendarValue] = Field(None, alias='value')
