...
class EmployeesUpdateEmployeeFieldsRequest1(BaseModel):
    # Employee first name
    employee[first_name]_: typing.Optional[str] = Field(None, alias='employee[first_name]')

    # Employee last name
    employee[last_name]_: typing.Optional[str] = Field(None, alias='employee[last_name]')
