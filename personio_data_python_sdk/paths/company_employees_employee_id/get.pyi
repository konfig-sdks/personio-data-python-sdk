...
from personio_data_python_sdk.model.employee_response import EmployeeResponse as EmployeeResponseSchema
...
from personio_data_python_sdk.type.employee_response import EmployeeResponse
...
from personio_data_python_sdk.pydantic.employee_response import EmployeeResponse as EmployeeResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeeResponseSchema
...
class ShowByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashow_by_id(
        self,
        employee_id: int,
        x_personio_partner_id: typing.Optional[str] = None,
        x_personio_app_id: typing.Optional[str] = None,
    ...
    def show_by_id(
        ...
        return self._show_by_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ShowById(BaseApi):
    ...
    async def ashow_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeResponsePydantic:
        raw_response = await self.raw.ashow_by_id(
            employee_id=employee_id,
            x_personio_partner_id=x_personio_partner_id,
            x_personio_app_id=x_personio_app_id,
            **kwargs,
        ...
        if validate:
            return RootModel[EmployeeResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(EmployeeResponsePydantic, raw_response.body)
    ...
    def show_by_id(
        ...
        raw_response = self.raw.show_by_id(
            employee_id=employee_id,
            x_personio_partner_id=x_personio_partner_id,
            x_personio_app_id=x_personio_app_id,
        )
