...
from personio_data_python_sdk.model.projects_get_all_response import ProjectsGetAllResponse as ProjectsGetAllResponseSchema

from personio_data_python_sdk.type.projects_get_all_response import ProjectsGetAllResponse

from ...api_client import Dictionary
from personio_data_python_sdk.pydantic.projects_get_all_response import ProjectsGetAllResponse as ProjectsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsGetAllResponsePydantic:
        ...
        if validate:
            return ProjectsGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsGetAllResponsePydantic, raw_response.body)
