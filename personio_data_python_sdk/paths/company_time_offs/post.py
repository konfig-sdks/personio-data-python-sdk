...
from personio_data_python_sdk.model.create_time_off_period_request import CreateTimeOffPeriodRequest as CreateTimeOffPeriodRequestSchema
...
from personio_data_python_sdk.model.absences_add_absence_data_response import AbsencesAddAbsenceDataResponse as AbsencesAddAbsenceDataResponseSchema
...
from personio_data_python_sdk.type.create_time_off_period_request import CreateTimeOffPeriodRequest
from personio_data_python_sdk.type.error_create_absence_response import ErrorCreateAbsenceResponse
from personio_data_python_sdk.type.absences_add_absence_data_response import AbsencesAddAbsenceDataResponse
...
from personio_data_python_sdk.pydantic.absences_add_absence_data_response import AbsencesAddAbsenceDataResponse as AbsencesAddAbsenceDataResponsePydantic
...
from personio_data_python_sdk.pydantic.create_time_off_period_request import CreateTimeOffPeriodRequest as CreateTimeOffPeriodRequestPydantic
...
# body param
SchemaForRequestBodyApplicationXWwwFormUrlencoded = CreateTimeOffPeriodRequestSchema


request_body_create_time_off_period_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AbsencesAddAbsenceDataResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AbsencesAddAbsenceDataResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_absence_data_mapped_args(
        self,
        employee_id: int,
    ...
    async def _aadd_absence_data_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_time_off_period_request.serialize(body, content_type)
...
class AddAbsenceDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_absence_data(
        self,
        employee_id: int,
        time_off_type_id: int,
        start_date: date,
        ...
        **kwargs,
        ...
        args = self._add_absence_data_mapped_args(
        ...
        return await self._aadd_absence_data_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def add_absence_data(
        self,
        employee_id: int,
        time_off_type_id: int,
        start_date: date,
        ...
        return self._add_absence_data_oapg(
            body=args.body,
            header_params=args.header,
        )

class AddAbsenceData(BaseApi):
    ...
    async def aadd_absence_data(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AbsencesAddAbsenceDataResponsePydantic:
        raw_response = await self.raw.aadd_absence_data(
            employee_id=employee_id,
            time_off_type_id=time_off_type_id,
            start_date=start_date,
            end_date=end_date,
        ...
        if validate:
            return AbsencesAddAbsenceDataResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AbsencesAddAbsenceDataResponsePydantic, raw_response.body)
    ...
    def add_absence_data(
        ...
        raw_response = self.raw.add_absence_data(
            employee_id=employee_id,
            time_off_type_id=time_off_type_id,
            start_date=start_date,
            end_date=end_date,
