...
from personio_data_python_sdk.model.public_list_reports_response import PublicListReportsResponse as PublicListReportsResponseSchema
...
from personio_data_python_sdk.type.public_list_reports_response import PublicListReportsResponse
...
from personio_data_python_sdk.pydantic.public_list_reports_response import PublicListReportsResponse as PublicListReportsResponsePydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'report_ids': typing.Union[ReportIdsSchema, list, tuple, ],
...
request_query_report_ids = api_client.QueryParameter(
    name="report_ids",
    style=api_client.ParameterStyle.FORM,
    schema=ReportIdsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = PublicListReportsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PublicListReportsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_metadata_mapped_args(
        ...
        if report_ids is not None:
            _query_params["report_ids"] = report_ids
    ...
    async def _aget_metadata_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/company/custom-reports/reports',
            headers=_headers,
        )
...
class GetMetadata(BaseApi):
    ...
    async def aget_metadata(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PublicListReportsResponsePydantic:
        raw_response = await self.raw.aget_metadata(
            x_personio_partner_id=x_personio_partner_id,
            x_personio_app_id=x_personio_app_id,
            report_ids=report_ids,
            status=status,
        ...
        if validate:
            return PublicListReportsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PublicListReportsResponsePydantic, raw_response.body)
    ...
    def get_metadata(
        ...
        raw_response = self.raw.get_metadata(
            x_personio_partner_id=x_personio_partner_id,
            x_personio_app_id=x_personio_app_id,
            report_ids=report_ids,
            status=status,
