...
from personio_data_python_sdk.model.employees_response import EmployeesResponse as EmployeesResponseSchema

from personio_data_python_sdk.type.employees_response import EmployeesResponse

from ...api_client import Dictionary
from personio_data_python_sdk.pydantic.employees_response import EmployeesResponse as EmployeesResponsePydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'attributes[]': typing.Union[AttributesSchema, list, tuple, ],
...
request_query_attributes_ = api_client.QueryParameter(
    name="attributes[]",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = EmployeesResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_list_mapped_args(
        ...
        attributes_: typing.Optional[typing.List[str]] = None,
        ...
        if attributes_ is not None:
            _query_params["attributes[]"] = attributes_
        if updated_since is not None:
            _query_params["updated_since"] = updated_since
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[EmployeesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(EmployeesResponsePydantic, raw_response.body)
